...
module.exports = async configFile => {
  try {
     ...
     */
    const customConfig = await utils.getConfigFile(configFile);
     ...
     * Configuro webpack
     */
    configWebpack.resolve.alias.config = '/didor.config.js';
    ...
    if (lib) {
      ...
      configWebpack.resolve.alias.styles = './default.style.scss';
    }
